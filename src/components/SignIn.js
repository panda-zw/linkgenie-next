      ...
      <section className="w-[692px] absolute top-[60px] border border-opacity-0 rounded bg-authgray opacity-80">
        ...
        <form onSubmit={handleSubmit} className="font-mulish">
          ...
          <div className="mb-4 flex flex-col">
            <label htmlFor="email" className="px-16 mb-3 text-white">Email address<span className="text-red-500">*</span></label>
          ...
          <div className="mb-4 flex flex-col">
            <label htmlFor="password" className="px-16 text-white mb-3">Password<span className="text-red-500">*</span></label>
            <div className="flex justify-center">
              <input
                type="password"
                id="password"
