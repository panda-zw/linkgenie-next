...
export default function SignIn() {
  ...
  return (
    <div className="flex items-center justify-center min-h-screen bg-oval-gradient from-[#324d7e] to-[#0e1726]">
      <section className="w-[600px] absolute top-[60px] border border-opacity-0 rounded-lg bg-authgray opacity-80">
        <h1 className="text-2xl text-white font-bold font-mulish text-center mt-7">Welcome back to <span className="text-green-500">LinkGenie</span></h1>
        <p className="text-center text text-white mt-3 font-mulish">Hello! We are thrilled to have you back</p>
        <form onSubmit={handleSubmit} className="font-mulish">
          ...
          <div className="mb-4 flex flex-col">
            <label htmlFor="email" className="px-12 mb-3 text-white">Email address<span className="text-red-500">*</span></label>
            <div className="flex justify-center">
              <input
                ...
                placeholder="Email"
                className="w-10/12 px-4 py-3 sm:py-4 text-sm sm:text-base text-white bg-ingray border border-white rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500"
              />
            </div>
          </div>
          <div className="mb-4 flex flex-col">
            <label htmlFor="password" className="px-12 text-white mb-3">Password<span className="text-red-500">*</span></label>
            <div className="flex justify-center">
              <input
                type="password"
                id="password"
