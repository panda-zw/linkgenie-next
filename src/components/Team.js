        ...
        <div className='items-center flex flex-col bg-white px-4 md:px-10'>
            <div className='flex space-x-20 py-20'>
                <div className='mt-28'>
                    ...
                    <p className=' mt-5 text-lgray'>Our mission is to unlock creativity, unleash innovation, and </p>
                    <p className='text-lgray'>transform the way professionals connect, collaborate, and </p>
                    <p className='text-lgray'>communicate. We believe that everyone deserves the tools and</p>
                    <p className='text-lgray'>committed to making that vision a reality.</p>
                </div>
