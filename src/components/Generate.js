...
function Generate() {
  ...
  const handleCopy = () => {
    navigator.clipboard
      .writeText(response || "No content generated.")
    ...
    <div className="min-h-screen px-4 lg:px-10 bg-gray-900">
      <div className="mt-10 max-w-full lg:max-w-3xl mx-auto">
        ...
        <p className="mt-5 text-gray-200 text-center lg:text-left text-lg">
          Your results may vary. We are working on fine-tuning results to match
          your style. Here are some tips to create better posts.
        </p>

        <form onSubmit={handleSubmit} className="mt-10 space-y-6 lg:space-y-8">
          <div>
            <h2 className="text-lg lg:text-xl text-gray-300">
              Describe your post in a clear and detailed manner
            </h2>
            <input
              type="text"
              value={userMessage}
          ...
          <div>
            <h2 className="text-lg lg:text-xl text-gray-300">
              How many posts do you want (1 credit per post)
            </h2>
            <input
              type="number"
              value={postCount}
...
>>>>>>> Stashed changes
          ...
          <div className="flex items-center">
            ...
            />
            <label className="ml-3 text-lg text-gray-300">
              Include Hashtags
            </label>
          </div>
